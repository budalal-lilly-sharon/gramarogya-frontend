...
export default function Emergency() {
  ...
  useAutoSpeak('Emergency page, Tap 108 for ambulance')
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#050505', paddingBottom:90, maxWidth:430, margin:'0 auto', position:'relative', overflow:'hidden', display:'flex', flexDirection:'column' }}>
      ...
      <div style={{ position:'relative', zIndex:2, textAlign:'center', marginTop:6 }}>
        <p style={{ color:'rgba(255,255,255,0.5)', fontSize:9, fontWeight:900, letterSpacing:3 }}>ONE TAP • LOCATION AUTO-SHARED</p>
      ...
      <div style={{ position:'relative', zIndex:2, padding:16, marginTop:18, display:'flex', flexDirection:'column', gap:10 }}>
        ...
        <div style={{ background:'white', borderRadius:16, padding:14 }}>
          <p style={{ fontWeight:900, fontSize:11, color:'#111827', letterSpacing:0.5 }}>HOW IT WORKS</p>
          <div style={{ marginTop:10, display:'flex', flexDirection:'column', gap:10 }}>
            ...
            <div style={{ display:'flex', gap:10, alignItems:'center' }}><div style={{ width:28, height:28, background:'#fef2f2', borderRadius:8, display:'flex', alignItems:'center', justifyContent:'center' }}>🚑</div><p style={{ fontSize:11, color:'#374151' }}><b>Nearest ambulance</b> dispatched in 2 mins</p></div>
